...
from shop.models import Product, Driver, Customer
...
from account.serializers import CustomerSerializer, DriverSerializer
...
def shop_report(request, user_id):
    try:
        ...
        shop = user.shop  # Assuming user has a shop attribute
